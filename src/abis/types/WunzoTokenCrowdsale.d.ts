...
interface WunzoTokenCrowdsaleInterface extends ethers.utils.Interface {
  functions: {
...
export class WunzoTokenCrowdsale extends BaseContract {
  ...
  interface: WunzoTokenCrowdsaleInterface;
